...
wdir_ff = "C:/Users/francesco/Documents/GitHub/Risk-of-Business-Failure"
wdir_sc = "/Users/samuele/University/2.SMD/Risk-of-Business-Failure"
setwd(wdir_ff)

#fread della libreria data.table è molto più veloce a caricare il dataframe
#df = fread("aida_preproc.csv") 
...
aida$ATECO.2007code <- as.character(aida$ATECO.2007code)

to.modify5=nchar(as.character(aida$ATECO.2007code))==5
to.modify1=nchar(as.character(aida$ATECO.2007code))==1

aida[to.modify1]$ATECO.2007code = sub("^", "000000", aida[to.modify1]$ATECO.2007code)
aida[to.modify5]$ATECO.2007code = sub("^", "0", aida[to.modify5]$ATECO.2007code)

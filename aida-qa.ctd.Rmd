...
m <- min( length(age.y1.failed),length(age.y2.failed), length(age.y3.failed), length(age.y4.failed), length(age.y5.failed) ) -1
...
x <- data.frame(y1=random.age.y1.failed, y2=random.age.y2.failed, y3=random.age.y3.failed, y4=random.age.y4.failed, y5=random.age.y5.failed)
...
# Friedman non-parametric test
x <- data.frame(y1=random.size.y1.failed, y2=random.size.y2.failed, y3=random.size.y3.failed, y4=random.size.y4.failed, y5=random.size.y5.failed)
friedman.test(data.matrix(x))

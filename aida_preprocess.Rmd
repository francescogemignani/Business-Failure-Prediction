...
skim(age.df)
save(age.df, file="../age_df.RData") # R binary format
```
...
skim(size.df)
save(size.df, file="../size_df.RData") # R binary format
```
...
# export age.df 
roi.df <- roi.df[,c('avg.roi','Legal.form','ATECO.Sector.Name','Registered.office.address.-.Region','Last.accounting.closing.date','Failed')]
skim(roi.df)
save(roi.df, file="../roi_df.RData") # R binary format
```
...
# export age.df 
solvency.df <- solvency.df[,c('avg.solvency','Legal.form','ATECO.Sector.Name','Registered.office.address.-.Region','Last.accounting.closing.date','Failed')]
skim(solvency.df)
save(solvency.df, file="../solvency_df.RData") # R binary format
```

...
ggplot(data=aida.yy, aes(x=Age, group=Failed, fill=Failed)) +
...
```{r}
age.yy.active <- aida.yy[aida.yy$Failed=='No','Age']
age.yy.failed <- aida.yy[aida.yy$Failed=='Yes','Age']
...
for(form.name in company.forms){
  print("**************************")
  print(form.name)
  age.yy.active <- aida.yy[aida.yy$Failed=='No' & aida.yy$Legal.form==form.name ,'Age']
  age.yy.failed <- aida.yy[aida.yy$Failed=='Yes'& aida.yy$Legal.form==form.name ,'Age']
...
for(sector.name in company.sectors){
  print("**************************")
  print(sector.name)
  age.yy.active <- aida.yy[aida.yy$Failed=='No' & aida.yy$ATECO.Sector.Name==sector.name ,'Age']
  age.yy.failed <- aida.yy[aida.yy$Failed=='Yes'& aida.yy$ATECO.Sector.Name==sector.name ,'Age']
...
ggplot(data=aida.yy, aes(x=Total.assetsth.EURLast.avail..yr, group=Failed, fill=Failed)) +
    geom_density(adjust=1.5, alpha=.4) +
    theme_ipsum() + 
...
```{r}
size.yy.active <- aida.yy[aida.yy$Failed=='No','Total.assetsth.EURLast.avail..yr']
size.yy.failed <- aida.yy[aida.yy$Failed=='Yes','Total.assetsth.EURLast.avail..yr']
...
for(form.name in company.forms){
  print("**************************")
  print(form.name)
  size.yy.active <- aida.yy[aida.yy$Failed=='No' & aida.yy$Legal.form==form.name ,'Total.assetsth.EURLast.avail..yr']
  size.yy.failed <- aida.yy[aida.yy$Failed=='Yes'& aida.yy$Legal.form==form.name ,'Total.assetsth.EURLast.avail..yr']
...
for(sector.name in company.sectors){
  print("**************************")
  print(sector.name)
  size.yy.active <- aida.yy[aida.yy$Failed=='No' & aida.yy$ATECO.Sector.Name==sector.name ,'Total.assetsth.EURLast.avail..yr']
  size.yy.failed <- aida.yy[aida.yy$Failed=='Yes'& aida.yy$ATECO.Sector.Name==sector.name ,'Total.assetsth.EURLast.avail..yr']
...
ggplot(data=aida.yy, aes(x=`Return.on.investment.(ROI).(%)%Last.avail..yr`, group=Failed, fill=Failed)) +
    geom_density(adjust=1.5, alpha=.4) +
    theme_ipsum() + 
...
```{r}
roi.yy.active <- aida.yy[aida.yy$Failed=='No','Return.on.investment.(ROI).(%)%Last.avail..yr']
roi.yy.failed <- aida.yy[aida.yy$Failed=='Yes','Return.on.investment.(ROI).(%)%Last.avail..yr']
...
for(form.name in company.forms){
  print("**************************")
  print(form.name)
  roi.yy.active <- aida.yy[aida.yy$Failed=='No' & aida.yy$Legal.form==form.name ,'Return.on.investment.(ROI).(%)%Last.avail..yr']
  roi.yy.failed <- aida.yy[aida.yy$Failed=='Yes'& aida.yy$Legal.form==form.name ,'Return.on.investment.(ROI).(%)%Last.avail..yr']
...
for(sector.name in company.sectors){
  print("**************************")
  print(sector.name)
  roi.yy.active <- aida.yy[aida.yy$Failed=='No' & aida.yy$ATECO.Sector.Name==sector.name ,'Return.on.investment.(ROI).(%)%Last.avail..yr']
  roi.yy.failed <- aida.yy[aida.yy$Failed=='Yes'& aida.yy$ATECO.Sector.Name==sector.name ,'Return.on.investment.(ROI).(%)%Last.avail..yr']
